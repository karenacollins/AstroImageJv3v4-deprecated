        ...
        if (g != null) {
            ...
            if (true)//!IJ.isMacOSX())
            {
                ...
                try {
                    ...
                    transEnabled = false;
                    if (overlay != null) this.drawOverlay(overlay, g);
...
//                    IJ.log("update: srcRect.x="+srcRect.x+"  srcRect.y="+srcRect.y);
            ...
            transEnabled = false;
            if (overlay != null) this.drawOverlay(overlay, offScreenGraphics);
    ...
    public Image graphicsToImage(Graphics g) {   //used by AstroStackWindow to save image display
        ...
        transEnabled = false;
        if (overlay != null) this.drawOverlay(overlay, imageGraphics);
