...
public class Focus_Telescope implements ActionListener, PlugIn {
    ...
    static String USE_ORDERED_SEQUENCE = "Ordered sequence";
    static String USE_UNORDERED_SEQUENCE = "Unordered sequence";
    static String USE_TABLE_COLUMN = "Use table column";
    static String USE_FILENAME = "Extract from file name";
    static String CANCEL = "Cancel";
    static String OK = "OK";
    static String MODE_SWITCH = "MODE";
    static String NEW_TABLE = "TABLE";
...
// IJ.log(""+i+": "+x[i]+","+y[i]);
    ...
    protected boolean gotFocusData() {
        ...
        if (way.equals(USE_TEXTAREA)) {
            return useSimpleDataPairs(text.getText());
        } else {
