...
//-----TEXT fields ------------------------------------------------------------------
            ...
            double[] coords = processCoordinatePair(RATextField, 3, 24, false, DecTextField, 2, 90, true, b == RATextField, true);
...
//        }
    ...
    public Dimension preferredLayoutSize(Container target) {
        Dimension dim = new Dimension(newCanvasWidth(), (this.getHeight() - 56));
...
//                imp.updateAndDraw();
    ...
    public void zoomControl(int screenX, int screenY, int magChangeSteps, boolean mouseClick) {
        ...
        double nextzoom = ImageCanvas.getLowerZoomLevel(zoom);
        ...
        {
            zoomOut((screenX), (screenY), mouseClick, false);
        } else if (magChangeSteps < 0)    //zoom in
        {
            zoomIn((screenX), (screenY), mouseClick, false, 0.0);
...
//                        }
    ...
    public void zoomIn(int screenX, int screenY, boolean mouseClick, boolean center, double factor) {
        ...
        if (mouseClick) {
            if (factor > 0.0)
                ...
                newMag = ImageCanvas.getHigherZoomLevel(magnification);
        } else
    ...
    public void zoomOut(int screenX, int screenY, boolean mouseClick, boolean center) {
        ...
        double newMag = magnification;
        if (mouseClick)
            newMag = ImageCanvas.getLowerZoomLevel(magnification);
        else
            newMag = magnification / 1.1;
