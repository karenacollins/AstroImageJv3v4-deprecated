 ...
 */
public class WCS {
    public static String PREFS_NPIX1 = "wcs.npix1";
    public static String PREFS_NPIX2 = "wcs.npix2";
    public static String PREFS_CRPIX1 = "wcs.crpix1";
    public static String PREFS_CRPIX2 = "wcs.crpix2";
    public static String PREFS_CRVAL1 = "wcs.crval1";
    public static String PREFS_CRVAL2 = "wcs.crval2";
    public static String PREFS_CDELT1 = "wcs.cdelt1";
    public static String PREFS_CDELT2 = "wcs.cdelt2";
    public static String PREFS_CTYPE1 = "wcs.ctype1";
    public static String PREFS_CTYPE2 = "wcs.ctype2";
    public static String PREFS_CD1_1 = "wcs.cd11";
    public static String PREFS_CD1_2 = "wcs.cd12";
    public static String PREFS_CD2_1 = "wcs.cd21";
    public static String PREFS_CD2_2 = "wcs.cd22";
    public static String PREFS_PC1_1 = "wcs.pc11";
    public static String PREFS_PC1_2 = "wcs.pc12";
    public static String PREFS_PC2_1 = "wcs.pc21";
    public static String PREFS_PC2_2 = "wcs.pc22";
    public static String PREFS_USENPIX = "wcs.usenpix";
    public static String PREFS_USECRPIX = "wcs.usecrpix";
    public static String PREFS_USECRVAL = "wcs.usecrval";
    public static String PREFS_USECDELT = "wcs.usecdelt";
    public static String PREFS_USECTYPE = "wcs.usectype";
    public static String PREFS_USECD = "wcs.usecd";
    public static String PREFS_USEPC = "wcs.usepc";
...
//        IJ.log(logInfo);
    ...
    public double getWCSDistance(double[] startRaDec, double[] endRaDec) {  // transcoded from wcs tools
        double distance = 0.0;
    ...
    public double getWCSDistance2(double[] startRaDec, double[] endRaDec) {  // transcoded from wcs tools
        double distance = 0.0;
        double d1, d2, diffi;
